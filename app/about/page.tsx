    ...
    <>
      <div className="container mx-auto py-10">
        ...
        <p>
          ...
          har högt till tak i guilden men när vi spelar, så spelar vi seriöst
          med fokus på progress. Vi värdesätter våra spelare och spelardynamik
          över allt annat.{" "}
        </p>
        ...
        <p>
          ...
          säsong. Alla är välkomna, unga, äldre, kvinnor, män, gröna, gula,
          växer & djur, logs är ett stort plus.
        </p>
